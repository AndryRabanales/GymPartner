                                    ...
                                    <div className="relative group flex items-center gap-0.5">
                                        <div className="relative flex items-center">
                                            ...
                                            <img
                                                src="/ginx.png"
                                                alt="GINX"
                                                className="h-10 w-auto sm:h-12 relative z-10 transition-all duration-500 group-hover:scale-110 drop-shadow-[0_0_20px_rgba(255,255,255,0.2)] animate-in zoom-in-50 duration-700"
                                            />
                                        </div>
                                        <div className="flex flex-col justify-center">
                                            <span className="font-black text-lg sm:text-xl tracking-[0.12em] bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 italic leading-normal pr-2 pb-0.5 group-hover:from-gym-primary group-hover:to-yellow-600 transition-all duration-500 uppercase" style={{ fontFamily: 'Impact, sans-serif' }} translate="no">
                                                GINX
                                            </span>
                                        </div>
                                    </div>
