...
import { MapPin, Edit2, LogIn, Loader, Swords, Dumbbell, LineChart, History, Star, Search, ArrowLeft, ArrowRight, Crown, Map as MapIcon, Image as ImageIcon, Palette, Dices } from 'lucide-react'; // Added Dices
        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8 pb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 md:gap-4">
                ...
                <button
                    ...
                    className="sm:col-span-3 group relative overflow-hidden bg-gradient-to-r from-yellow-400 to-orange-500 rounded-3xl p-1 shadow-[0_0_20px_rgba(250,204,21,0.3)] hover:shadow-[0_0_40px_rgba(250,204,21,0.6)] hover:-translate-y-1 transition-all duration-300 active:scale-95 ring-4 ring-yellow-400/20"
                >
