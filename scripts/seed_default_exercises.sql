-- Este script limpia y sincroniza el catálogo de ejercicios de GymPartner
-- con los 92 ejercicios premium que cuentan con imágenes sin fondo.

-- 1. Limpieza de ejercicios obsoletos
DELETE FROM public.exercises;

-- 2. Inserción de los ejercicios con imágenes
